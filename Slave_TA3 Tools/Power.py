...
parser.add_argument('Data', type=str, nargs='?', help='Data for Power Outputs (binary, xxxxx_xxxxx)')
...
powers = SlaveTA.Powers(port=args.Port, address=address)

commands = {'RI': powers.read_idr,
            'RO': powers.read_odr,
            'WZ': powers.write_zeros,
            'WO': powers.write_ones,
            'WD': powers.write_data}
